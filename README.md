...
### [머신러닝 파트]
- KNU 한국어 감성사전을 마스크 리뷰 데이터에 맞게 추가 및 수정 -> 마스크 리뷰 데이터를 Mecab 형태소 분리기로 분리 -> 전체 리뷰와 사이즈, 호흡, 착용감, 배송을 언급한 문장들을 구축한 감성사전을 통해 감정분류 -> 알고리즘을 통해 세부 사항과 리뷰 전체 데이터를 점수화해서 사용자에게 전달
