    ...
    <div>
      <Main>
        ...
        >
          ...
          <IntroSection>
            ...
            <LeftIntroDiv>
              ...
              <IntroContentDiv>
                <p>
                  <BasicSpan>
                    네이버 최저가를 기준으로 가격을 측정하므로 질 좋고 딱 맞는
                    저렴한 마스크를 구매버튼을 통해 만나보실 수 있습니다.
                  </BasicSpan>
                </p>
              </IntroContentDiv>
            </LeftIntroDiv>
            ...
            <CenterIntroDiv>
              ...
              <IntroContentDiv>
                <p>
                  <BasicSpan>
                    마스크 착용 후기를 자연어 처리(NLP)로 분석하여 마스크의
                    사이즈 및 착용감, 호흡 등에 대한 정보를 제공합니다.
                  </BasicSpan>
                </p>
              </IntroContentDiv>
            </CenterIntroDiv>
            ...
            <RightIntroDiv>
              ...
              <IntroContentDiv>
                <p>
                  <BasicSpan>
                    Masinsa’s Best는 상품의 클릭수, 평점, 리뷰를 기준으로 선별된
                    상품이며, 당사 및 타사의 정보의 합한 값을 기본으로 합니다.
                  </BasicSpan>
                </p>
              </IntroContentDiv>
            </RightIntroDiv>
          ...
          <div>
            <GoListBtnDiv>
              👉 <GoListLinkBox href="/">Going to see Mask</GoListLinkBox>
            </GoListBtnDiv>
          </div>
        </div>
      </Main>
